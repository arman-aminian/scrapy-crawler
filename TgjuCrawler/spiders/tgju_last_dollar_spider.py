...
class TGJUSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://api.tgju.online/v1/market/indicator/summary-table-data/price_dollar_rl?lang=fa&order_dir=asc&draw=2'
        '&columns '
        ...
        '=true&columns%5B7%5D%5Bsearch%5D%5Bvalue%5D=&columns%5B7%5D%5Bsearch%5D%5Bregex%5D=false&start=0&length=1'
